...
import uppgift2.StopWatch;
import uppgift3.PairDTO;
	import uppgift3.MyStack;

	/**
	 * The program returns the 1-nth most frequently used words in the text
	 * 
	 * @author danielduner
	 *
	 * @param <Key>
	 * @param <Value>
	 */
	public class ExtendedBST<Key extends Comparable<Key>, Value extends Comparable<Value>> {
		private Node root;
		private Value maxV;
		private Key maxK;
		...
		public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
			...
			ExtendedBST<String, Integer> st = new ExtendedBST<String, Integer>();
